				...
				<div className="space-y-6 text-sm text-gray-200 leading-relaxed">
					<div>
						...
						<p className="mb-3">
							...
							quando você cria uma conta, preenche formulários ou entra em
							contato conosco. Isso pode incluir:
						</p>
					...
					<div>
						...
						<ul className="list-disc list-inside space-y-1 ml-4">
							...
							<li>
								Comunicar-nos com você sobre produtos e serviços (conforme suas
								preferências)
							</li>
					...
					<div>
						...
						<p className="mb-3">
							...
							com terceiros para fins comerciais, exceto nas seguintes
							situações:
						</p>
						<ul className="list-disc list-inside space-y-1 ml-4">
					...
					<div>
						...
						<p>
							...
							criptografia de dados, controles de acesso e monitoramento regular
							de nossos sistemas.
						</p>
					</div>
					...
					<div>
						...
						<p>
							...
							experiência, analisar o uso de nossos serviços e personalizar
							conteúdo. Você pode gerenciar suas preferências de cookies através
					...
					<div>
						...
						<p>
							...
							para cumprir os propósitos para os quais foram coletadas,
							incluindo requisitos legais, contábeis ou de relatórios.
						</p>
					</div>
					...
					<div>
						...
						<p>
							...
							Notificaremos você sobre mudanças significativas através de e-mail
							ou aviso em nossa plataforma.
						</p>
					</div>
