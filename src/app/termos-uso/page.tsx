...
export default function TermsOfUsePage() {
	const navigationLinks = (
		<div className="flex flex-col gap-2 text-sm text-[#6B9FE8] w-full text-center">
			<p>
		...
		<AuthLayout title="Termos de Uso" navigationLinks={navigationLinks}>
			<div className="max-h-[500px] overflow-y-auto pr-2">
				<div className="space-y-6 text-sm text-gray-200 leading-relaxed">
					<div>
						<h2 className="text-lg font-semibold text-[#6B9FE8] mb-3">
							1. Aceitação dos Termos
						</h2>
						<p>
							Ao acessar e usar os serviços da Pharmédice, você concorda em
					...
					<div>
						...
						<p className="mb-3">
							A Pharmédice fornece uma plataforma digital para gestão de
							resultados de exames laboratoriais e comunicação entre
							laboratórios e pacientes. Nossos serviços incluem:
						</p>
					...
					<div>
						...
						<p className="mb-3">
							Você concorda em usar nossos serviços apenas para fins legítimos e
							de acordo com estes termos. É proibido:
						</p>
						<ul className="list-disc list-inside space-y-1 ml-4">
							<li>
								Usar os serviços para qualquer finalidade ilegal ou não
								autorizada
							</li>
							<li>Tentar ganhar acesso não autorizado aos nossos sistemas</li>
							<li>
								Interferir ou interromper a integridade ou desempenho dos
								serviços
							</li>
							<li>Compartilhar suas credenciais de acesso com terceiros</li>
							<li>
								Usar informações obtidas através dos serviços para fins
								comerciais não autorizados
							</li>
						</ul>
					</div>
					...
					<div>
						...
						<p>
							Levamos a privacidade de seus dados a sério. Todas as informações
							pessoais e médicas são tratadas de acordo com nossa Política de
							Privacidade e em conformidade com a Lei Geral de Proteção de Dados
					...
					<div>
						...
						<p>
							...
							nossos serviços, incluindo software, design, conteúdo e marcas
							registradas, pertencem à Pharmédice ou aos seus licenciadores.
							Você não pode copiar, modificar ou distribuir qualquer parte de
							nossos serviços sem autorização prévia.
						</p>
					</div>
					...
					<div>
						...
						<p>
							...
							qualquer momento, com ou sem aviso prévio, se você violar estes
							termos ou se determinarmos que tal ação é necessária para proteger
					...
					<div>
						...
						<p>
							...
							alterações entrarão em vigor imediatamente após a publicação. Seu
							uso continuado dos serviços após as modificações constitui
					...
					<div>
						...
						<p>
							...
							conosco através do e-mail: suporte@pharmedice.com.br
						</p>
					</div>

					<div className="bg-gray-900 p-4 rounded-lg border-l-4 border-[#6B9FE8]">
