...
export default function UserEditModal({ user, onClose, onSuccess }: UserEditModalProps) {
	...
	return (
		<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
			<div className="bg-[#252220] rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
				<div className="p-6 border-b flex items-center justify-between sticky top-0 bg-[#252220] z-10">
					<h2 className="text-2xl font-bold text-gray-100">Editar Usuário</h2>
					<button
						onClick={onClose}
				...
				<form onSubmit={handleSubmit} className="p-6">
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div>
							...
							<input
								...
								className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#6B9FE8] focus:border-transparent ${
									errors.primeiro_nome ? 'border-red-500' : 'border-gray-600'
								}`}
								disabled={loading}
							/>
						...
						<div>
							...
							<input
								...
								className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#6B9FE8] focus:border-transparent ${
									errors.segundo_nome ? 'border-red-500' : 'border-gray-600'
								}`}
								disabled={loading}
							/>
							{errors.segundo_nome && (
						...
						<div>
							...
							<input
								...
								className="w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-[#6B9FE8] focus:border-transparent"
								disabled={loading}
							/>
						</div>
					...
					<div className="mt-6">
						<button
							...
							className="text-[#6B9FE8] hover:text-blue-700 text-sm font-medium"
						>
						...
						<div className="space-y-2">
							<div className="flex items-center">
								<input
									...
									className="h-4 w-4 text-[#6B9FE8] rounded focus:ring-[#6B9FE8]"
									disabled={loading}
								/>
					...
					<div className="mt-6 pt-6 border-t bg-[#2d2823] -mx-6 px-6 py-4 flex justify-end gap-3 sticky bottom-0">
						<button
							type="button"
							onClick={onClose}
						...
						<button
							type="submit"
							className="px-6 py-2 bg-[#6B9FE8] text-white rounded-lg hover:bg-[#4E7FC6] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
							disabled={loading}
						>
							{loading && (
